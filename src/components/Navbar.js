...
const Navbar = () => {
  ...
  return (
    <nav className="bg-white fixed z-10 top-0 left-0 right-0 border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-900">
...
// <nav className="p-3 fixed z-10 top-0 left-0 right-0 border-gray-200 rounded bg-gray-50 dark:bg-gray-800 dark:border-gray-700">
//   <div className="container flex flex-wrap items-center justify-between mx-auto">
//     <Link to="/" className="flex items-center">
//       <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">
//         <i>Daily News</i>
